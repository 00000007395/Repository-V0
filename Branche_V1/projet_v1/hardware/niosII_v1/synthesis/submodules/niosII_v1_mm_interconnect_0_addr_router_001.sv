...
module niosII_v1_mm_interconnect_0_addr_router_001_default_decode
  #(
...
module niosII_v1_mm_interconnect_0_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD7 = log2ceil(64'h4003050 - 64'h4003048); 
    // -------------------------------------------------------
    ...
    niosII_v1_mm_interconnect_0_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x4003020 .. 0x4003030 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 27'h4003020  && read_transaction  ) begin
    ...
    // ( 0x4003048 .. 0x4003050 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4003048   ) begin
